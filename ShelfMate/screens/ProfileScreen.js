...
import { View, Text, Switch, Button, Alert, TouchableOpacity } from 'react-native';
...
{/* Header Section */}
<View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 15, marginTop: 15, marginLeft: 15, marginRight: 40 }}>
<TouchableOpacity onPress={() => navigation.goBack()}>
<FontAwesome name="arrow-left" size={20} color="green" style={{ marginRight: 10 }} />
</TouchableOpacity>


<Text style={{ fontSize: 22, fontWeight: 'bold', textAlign: 'center', flex: 1 }}>Settings</Text>
</View>
